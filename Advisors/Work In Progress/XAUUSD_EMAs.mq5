...
- LONG
   - Entry
      - No longs open
      - EMA 200 > EMA 100 > EMA 65 
      - Low < EMA 65 
      - High > EMA 65
      - (Test for 1.0) EMA 100 * 100 / EMA 200 > Z

   - Add positions (Pyramiding)
      - At least 1 long is open
      - Stoch[2] < X
      - Stoch[1] - Stoch[2] > Y 
...
int stoch_handle, ema_200_handle, ema_100_handle, ema_65_handle;
double stoch_buffer[], ema_200_buffer[], ema_100_buffer[], ema_65_buffer[];
...
int OnInit(){
   ...
   // Init indicators
   stoch_handle = iStochastic(asset, period, 14, 3, 1, MODE_SMA, STO_LOWHIGH);
